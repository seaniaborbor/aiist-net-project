<div class="col-sm-12 col-sm-6 col-xl-6">
    ...
    <form  action="<?=base_url('/dashboard/course/')?>"  method="post" enctype="multipart/form-data">
    <div class="bg-light rounded h-100 p-4">
    <h6 class="mb-4">Add New course</h6>
    <div class="form-floating mb-3">
        <input type="text" name="courseName" class="form-control" id="floatingInput"
    ...
    <div class="form-floating mb-3">
        <input type="text" name="courseDuration" class="form-control" id="floatingInput"
            placeholder="Eg: VIP Security">
    ...
    <div class="form-floating mb-3">
        ...
        <label for="floatingSelect">Indicate the genera career of this course </small></label>
    ...
    <button type="submit" class="btn btn-primary mt-3">Publish Course</button>
</div>
</div>
